...
public class QuantityController {
    ...
    private String price() throws IOException {
        ...
        try {
            FileWriter file ;
            for(int i=1; ;i++){
                File f = new File("C:/Users/Shahriar Rahman/OneDrive/onlinefood/src/main/java/com/example/onlinefood/"+i+".txt");
                if(!f.exists()){
                    file = new FileWriter("C:/Users/Shahriar Rahman/OneDrive/onlinefood/src/main/java/com/example/onlinefood/"+i+".txt", true);
                    fileName = i+".txt";
                    break;
                }
            }
